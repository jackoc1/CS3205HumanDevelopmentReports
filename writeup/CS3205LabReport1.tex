...
Figures 4.27-4.32 provide an overview of the different projections I did while changing the parameters of LSP. Papers which were hard to separate are included next to each projection in the figure graphic and can be viewed full size by clicking the picture as they are all live links.
...
\subsubsection{LSP}
Figures 4.47-4.52 provide an overview of the different projections I did while changing the parameters of LSP. Headlines which were hard to separate are included next to each projection in the figure graphic and can be viewed full size by clicking the picture as they are all live links.
...
\pagebreak
\subsubsection{t-SNE}Figures 4.53-4.58 provide an overview of the different projections I did while changing the parameters of t-SNE. Headlines which were hard to separate are included next to each projection in the figure graphic and can be viewed full size by clicking the picture as they are all live links.
...
\pagebreak
\subsubsection{ProjClus}
Figures 4.59-4.64 provide an overview of the different projections I did while changing the parameters of LSP. Headlines which were hard to separete are included next to each projection in the figure graphic and can be viewed full size by clicking the picture as they are all live links.
